...
- Usage: Reference from command with `@/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
