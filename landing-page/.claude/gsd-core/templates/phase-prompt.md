...
<!-- For checkpoint task examples and patterns, see @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
