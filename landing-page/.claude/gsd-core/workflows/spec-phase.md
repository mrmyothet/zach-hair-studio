...
ones). Reference: @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/templates/spec.md.
