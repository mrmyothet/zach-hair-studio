...
INSTALL_JS_GLOBAL="/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
