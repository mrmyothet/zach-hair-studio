...
```
Agent(
  prompt="Read /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/templates/SECURITY.md`
