...
<required_reading>
@/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/ai-frameworks.md
@/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-eval-planner.md for instructions.
