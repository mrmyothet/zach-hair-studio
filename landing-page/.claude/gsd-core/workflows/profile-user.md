...
Key references:
- @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md" "/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/CLAUDE.md
```
