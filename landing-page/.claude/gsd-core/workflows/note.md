...
- **Global scope**: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/notes/`)
...
2. Glob `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/notes/` — works in any directory
