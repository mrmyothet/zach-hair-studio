...
The keys live in `.claude/settings.json` (project) or `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/settings.json` (global) — **not** in `.planning/config.json`:
