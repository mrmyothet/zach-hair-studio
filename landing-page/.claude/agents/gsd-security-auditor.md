...
**Verification depth scales with `asvs_level`** (see @/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
