...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/.gsd-surface.json`
(sibling to `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills`).
...
`/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/.gsd-surface.json`
Install profile marker: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/.gsd-profile`
Skill dirs: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/skills/gsd-*/`
Engine module: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/myothet/repos/vct/zach-hair-studio/landing-page/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
