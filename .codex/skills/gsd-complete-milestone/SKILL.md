...
- @/workspaces/zach-hair-studio/.codex/gsd-core/workflows/complete-milestone.md (main workflow)
- @/workspaces/zach-hair-studio/.codex/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
