...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/workspaces/zach-hair-studio/.codex/.gsd-surface.json`
(sibling to `/workspaces/zach-hair-studio/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/workspaces/zach-hair-studio/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`/workspaces/zach-hair-studio/.codex/skills`).
...
`/workspaces/zach-hair-studio/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/workspaces/zach-hair-studio/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/workspaces/zach-hair-studio/.codex/.gsd-surface.json`
Install profile marker: `/workspaces/zach-hair-studio/.codex/.gsd-profile`
Skill dirs: `/workspaces/zach-hair-studio/.codex/skills/gsd-*/`
Engine module: `/workspaces/zach-hair-studio/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/workspaces/zach-hair-studio/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
