...
<!-- For checkpoint task examples and patterns, see @/workspaces/zach-hair-studio/.codex/gsd-core/references/checkpoints.md -->
...
See `/workspaces/zach-hair-studio/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspaces/zach-hair-studio/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/workspaces/zach-hair-studio/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
