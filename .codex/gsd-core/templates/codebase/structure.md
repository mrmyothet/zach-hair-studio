...
- Usage: Reference from command with `@/workspaces/zach-hair-studio/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspaces/zach-hair-studio/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspaces/zach-hair-studio/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
