...
Read and follow `/workspaces/zach-hair-studio/.codex/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
