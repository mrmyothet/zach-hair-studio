...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/zach-hair-studio/.codex
                  → checks /workspaces/zach-hair-studio/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/zach-hair-studio/.codex/gsd-core
                  → writes to /workspaces/zach-hair-studio/.codex/gsd-core/hooks/
