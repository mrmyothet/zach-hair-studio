...
<template>
@/workspaces/zach-hair-studio/.codex/gsd-core/templates/UAT.md
</template>
...
Read and follow `/workspaces/zach-hair-studio/.codex/gsd-core/workflows/transition.md`.
...
- Follow @/workspaces/zach-hair-studio/.codex/gsd-core/workflows/diagnose-issues.md
