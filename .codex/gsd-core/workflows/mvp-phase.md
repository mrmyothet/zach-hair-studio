...
<required_reading>
@/workspaces/zach-hair-studio/.codex/gsd-core/references/user-story-template.md
@/workspaces/zach-hair-studio/.codex/gsd-core/references/spidr-splitting.md
@/workspaces/zach-hair-studio/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/workspaces/zach-hair-studio/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/workspaces/zach-hair-studio/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/workspaces/zach-hair-studio/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
