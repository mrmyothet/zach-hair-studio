...
```
Agent(
  prompt="Read /workspaces/zach-hair-studio/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/zach-hair-studio/.codex/gsd-core/templates/SECURITY.md`
