...
<required_reading>
@/workspaces/zach-hair-studio/.codex/gsd-core/references/ai-frameworks.md
@/workspaces/zach-hair-studio/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspaces/zach-hair-studio/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-eval-planner.md for instructions.
