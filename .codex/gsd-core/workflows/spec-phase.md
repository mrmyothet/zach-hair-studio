...
ones). Reference: @/workspaces/zach-hair-studio/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /workspaces/zach-hair-studio/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/workspaces/zach-hair-studio/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/workspaces/zach-hair-studio/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/workspaces/zach-hair-studio/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/workspaces/zach-hair-studio/.codex/gsd-core/templates/spec.md.
