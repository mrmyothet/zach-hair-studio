...
```
Agent(
  prompt="Read /workspaces/zach-hair-studio/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/zach-hair-studio/.codex/gsd-core/templates/VALIDATION.md`
