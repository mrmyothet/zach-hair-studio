...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspaces/zach-hair-studio/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspaces/zach-hair-studio/.codex/agents/gsd-ui-checker.md for instructions.
...
@/workspaces/zach-hair-studio/.codex/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspaces/zach-hair-studio/.codex.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspaces/zach-hair-studio/.codex/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspaces/zach-hair-studio/.codex/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
