...
Key references:
- @/workspaces/zach-hair-studio/.codex/gsd-core/references/ui-brand.md (display patterns)
- @/workspaces/zach-hair-studio/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspaces/zach-hair-studio/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "/workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md" "/workspaces/zach-hair-studio/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspaces/zach-hair-studio/.codex/gsd-core/references/user-profiling.md`
...
Reference: @/workspaces/zach-hair-studio/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /workspaces/zach-hair-studio/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /workspaces/zach-hair-studio/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /workspaces/zach-hair-studio/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/workspaces/zach-hair-studio/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /workspaces/zach-hair-studio/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /workspaces/zach-hair-studio/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        /workspaces/zach-hair-studio/.codex/AGENTS.md
```
