...
Use template from `/workspaces/zach-hair-studio/.codex/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/workspaces/zach-hair-studio/.codex/gsd-core/templates/UI-SPEC.md`
