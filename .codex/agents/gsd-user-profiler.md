...
<reference>
@/workspaces/zach-hair-studio/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/zach-hair-studio/.codex/gsd-core/references/user-profiling.md` to load:
