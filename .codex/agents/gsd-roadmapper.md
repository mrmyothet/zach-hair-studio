...
Reference full template: `/workspaces/zach-hair-studio/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/zach-hair-studio/.codex/gsd-core/templates/state.md`.
