...
<required_reading>
@/workspaces/zach-hair-studio/.codex/gsd-core/references/verification-overrides.md
...
@/workspaces/zach-hair-studio/.codex/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/workspaces/zach-hair-studio/.codex/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/workspaces/zach-hair-studio/.codex/gsd-core/references/verify-mvp-mode.md`.
